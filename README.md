...
همچنین مشاهده می‌شود که با بهینه‌کردن تابع temp()، تابع خط بعدِ آن یعنی eval() نیز که تابع اصلی در این پروژه است اجرا می‌شود و خروجی No نمایش داده شده است.
...
در ادامه نتایج اجرای پروفایلینگ برای کد قبلا از بهینه کردن آن را مشاهده می‌کنیم. در این نتایج تابع findClosestPair همان‌طور که مشاهده می‌شود بیشترین تاثیر را در استفاده ار منابع دارد:
...
با استفاده از الگوریتم divide and conquer همانطور که در کد ClosestPairOpt در فولد section2 مشاهده می‌کنید سعی می‌کنیم فرایند پیدا کردن نزدیک ترین نقاط و تابع closestPair را بهینه کنیم و پس از انجام پروفالینگ به نتایج زیر می‌رسیم و مدت زمان استفاده از منابع همان‌طور که در عکس‌ها آمده است کاهش یافته است:
